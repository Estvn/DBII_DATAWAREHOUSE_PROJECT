...
IS 
   FUNCTION FN_OBTENER_TIEMPOS(QUERY_ORIGIN_TBL_TIEMPO VARCHAR2) RETURN SYS_REFCURSOR;
   PROCEDURE SP_INSERTAR_TIEMPOS(QUERY_ORIGIN_TBL_TIEMPO VARCHAR2, MSJ OUT VARCHAR2);
...
IS 
    ...
    BEGIN
        ...
        -- The variable has the necesary query to get all the values from the origin table.
        OPEN DATOS_TIEMPOS FOR QUERY_ORIGIN_TBL_TIEMPO;
    ...
    BEGIN
        DATOS_OBTENIDOS := FN_OBTENER_TIEMPOS(QUERY_ORIGIN_TBL_TIEMPO);
...
DECLARE
    ...
    QUERY_ORIGIN_TBL_TIEMPO VARCHAR2(1500):= 'SELECT 
...
BEGIN
    PK_ETL_TIEMPO.SP_INSERTAR_TIEMPOS(QUERY_ORIGIN_TBL_TIEMPO , MENSAJE);
